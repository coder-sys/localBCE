...
use stark_engine::{StarkBridgeInput, production_proof_artifact::ProductionStarkProofArtifactV1};
...
fn run() -> Result<(), Vec<String>> {
    ...
    let artifact = ProductionStarkProofArtifactV1::from_bridge_input(&bridge)?;
