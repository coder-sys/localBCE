...
use stark_engine::production_verifier_handoff::ProductionStarkVerifierHandoffV4;
...
fn run() -> Result<(), Vec<String>> {
    ...
    println!(
        ...
        serde_json::json!({
            ...
            "nullifier_root_before": handoff.nullifier_root_before,
            "nullifier_root_after": handoff.nullifier_root_after,
            "batch_root": handoff.batch_root,
