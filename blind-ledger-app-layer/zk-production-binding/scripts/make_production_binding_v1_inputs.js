...
const OUT_DIR = path.join(__dirname, "..", "inputs-v1");
const DEPTH = 10;
...
async function main() {
  ...
  function addNullifierTransition(v) {
    const nullifier = hash(v.rawClaimHash, v.providerKey, v.serviceDate, v.procedureCode);
  ...
  console.log(`wrote v1 inputs to ${OUT_DIR}`);
