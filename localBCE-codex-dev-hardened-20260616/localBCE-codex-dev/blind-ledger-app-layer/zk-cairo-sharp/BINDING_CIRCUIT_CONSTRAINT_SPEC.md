...
Production field strategy is STARK_FIELD_END_TO_END:
...
- Duplicate keys, nullifiers, claim/result/payment roots, fee roots, ruleset
  ...
  field.
- Modulo reduction between unrelated fields is forbidden.
- Any future bridge must be specified, audited, and approved as a separate
  production change.
